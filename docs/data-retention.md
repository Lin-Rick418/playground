...
| `idempotency_keys` scopes matching `mines.%`, `plinko.%`, `hilo.%`, `blackjack.%`                        | Permanent                                                                                | Prevents historical retries from becoming new wagers or settlements, including long-lived ACTIVE rounds. |
...
| `game_rounds`, `bets`, `mines_rounds`, `plinko_rounds`, `hilo_rounds`, `hilo_round_steps`, `blackjack_rounds`, `blackjack_round_actions` | Permanent                                                                                | Game and wagering history.                                                                               |
